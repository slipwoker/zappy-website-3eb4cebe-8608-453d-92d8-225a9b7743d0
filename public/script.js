document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      fetch(action, {
        ...
        .catch(function () {
          let errorMsg = contactForm.querySelector('.form-submit-error');
          if (!errorMsg) {
          ...
          errorMsg.textContent = contactForm.dataset.errorMessage || 'Something went wrong. Please try again.';
        })
        .finally(function () {
          if (submitBtn) {
  ...
  const OBSERVE_SELECTOR = '.fade-in, .scroll-animate, [data-animate]';
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "shopleg משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '3eb4cebe-8608-453d-92d8-225a9b7743d0',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '3eb4cebe-8608-453d-92d8-225a9b7743d0';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '3eb4cebe-8608-453d-92d8-225a9b7743d0';
